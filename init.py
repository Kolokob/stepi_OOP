...
#         self.ep = (c, d)
#
#     # формируем 217 обьектов с рандомными координатами и
#     # сохраняем в новый список elements,
#     # И для каждого обьекта класс выбирается рандомом
#     # И после всего этого обнуляем класс Line
#
